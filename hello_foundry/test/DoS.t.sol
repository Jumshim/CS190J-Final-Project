...
contract DoSTest is Test {
    ...
    function testAddManyContracts() public {
        ...
        ContractStruct.JobContract memory jobContract = marketplace.viewContract(numContracts - 1);
        assertEq(jobContract.employer, employer, "Employer address mismatch for the last contract");
        assertEq(jobContract.freelancer, freelancer, "Freelancer address mismatch for the last contract");
        assertEq(jobContract.value, 1 ether, "Contract value mismatch for the last contract");
    }
}
